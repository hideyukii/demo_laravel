...
Route::group(["middleware" => "auth"], function () {
    ...
    Route::get("/backlog/user-plan/{id}", [BackLogController::class, "getUserPlan"]);
    Route::get("/backlog/add-user-plan", [BackLogController::class, "getAddUserPlan"]);
    Route::post("/backlog/add-user-plan", [BackLogController::class, "postAddUserPlan"]);
});
